...
namespace PinnaFace.Core
{
    public class DbUtil : IDisposable
    {
        ...
        {
            //_dbConnection=new OleDbConnection();//Connection();
        ...
        public static int GetIntegerValueCe(ref SqlCeDataReader row, string fieldName)
        {
            try
            {
                if (!row.IsDBNull(row.GetOrdinal(fieldName)))
        ...
        public static DateTime GetDateTimeValueCe(ref SqlCeDataReader row, string fieldName)
        {
            try
            {
                if (!row.IsDBNull(row.GetOrdinal(fieldName)))
